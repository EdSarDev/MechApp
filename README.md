# MechApp: Una aplicación para ingeniería mecánica
...
- Modelo: Son las bases de datos, librerías, etc. que contienen los insumos para hacer los cálculos dentro de las herramientas, cuando sean requeridos.
- Controlador: Son los métodos numéricos, fórmulas, ecuaciones, etc. que permiten hacer los cálculos dentro de las herramientas.
- Vista: Es la interfaz frágica (GUI) a través de la cual el usuario interactúa con las herramientas de la aplicación MechApp. Está construida con el módulo de generación de GUIs de NetBeans 8.2, la cual usa las librerías "awt" y "swing" de Java. 
